...
void hmsLivetimes(Int_t run=1565){
  ...
  TSH->SetBranchAddress("H.hTRIG2.scaler", &trig_scaler);
  TSH->SetBranchAddress("H.hTRIG2.scalerRate", &trig_scalerRate);
  ...
  */
  ...
  ofstream ofile;
  ofile.open("hmsLivetimes.txt",ios::app | ios::out );
