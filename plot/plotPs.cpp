...
void plotPs(){
  ...
  */
  ...
  leg->AddEntry(gr1t,"TRIG2_{tdc hits}/TRIG2_{scalers}","p");
  leg->AddEntry(flt,"LT=#frac{1}{1+(trig2rate/prescale)#tau}","l");
  /*
